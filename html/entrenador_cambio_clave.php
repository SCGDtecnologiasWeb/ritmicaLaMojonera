...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $sql_get_hash = "SELECT `claveAcceso` FROM `Entrenador` WHERE `idEntrenador` = {$_SESSION["id"]}";
  $resultado = mysqli_query($link, $sql_get_hash);
  $fila = mysqli_fetch_assoc($resultado);
  $old_hash = $fila["claveAcceso"];
  ...
  if (empty($oldPass_err) && empty($newPass_err) && empty($confirmPass_err)) {
    ...
    $sql_update_pass = "UPDATE `Entrenador` SET `claveAcceso` = '{$new_hash}' WHERE `idEntrenador` = {$_SESSION["id"]}";
  ...
  <div class="main">
    <div class="content-container">
      ...
      <div class="form-container">
        <form action="/html/entrenador_cambio_clave.php" method="POST" enctype="multipart/form-data">
