      ...
      <div class=\"form-container\">
        <form action=\"/php/entrenador_datos.php\" method=\"POST\">
          <div class=\"form-field\">
            ...
            <input type=\"email\" value=\"{$resultado["correoEntrenador"]}\" id=\"email\" name=\"email\" pattern=\"([a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,})\" required />
            <input typer=\"text\" hidden value=\"$idEntrenador\" id=\"idEntrenador\" name=\"idEntrenador\"><br />
          </div>
          <div class=\"form-field\">
            <label for=\"password\" class=\"field-title\">Contraseña *</label><br />
            <input type=\"text\" value=\"{$resultado["claveAcceso"]}\" id=\"password\" name=\"password\" pattern=\"([a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,})\" required /><br />
          </div>

          <div class=\"form-field\">
            <label for=\"name\" class=\"field-title\">Nombre completo</label><br />
            <input type=\"text\" value=\"{$resultado["nombreCompleto"]}\" id=\"name\" name=\"name\" autocomplete=\"off\" pattern=\"[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,96}\" /><br />
          </div>

          <div class=\"form-field\">
            <label for=\"dni\" class=\"field-title\">DNI/NIE</label><br />
            <input type=\"text\" value=\"{$resultado["DNI"]}\" id=\"dni\" name=\"dni\" autocomplete=\"off\" pattern=\"((([x-zX-Z])|([lmLM])|[0-9]){1}([ ]?)(([0-9]){7})([-]?)([a-zA-Z]{1}))\" minlength=\"9\" maxlength=\"11\" /><br />
          </div>
          ...
          <div class=\"form-field\">
            ...
            <label id=\"tlf-prefijo\">
              <input type=\"text\" value=\"{$resultado["telefono"]}\" id=\"whatsapp\" name=\"whatsapp\" class=\"ibacor_fi\" data-prefix=\"\" autocomplete=\"off\" pattern=\"(((([6]{1})([0-9]{2}))|(([7]{1})([1-4]{1})([0-9]{1})))([ ]?)((([0-9]{2})([ ]?)([0-9]{2})([ ]?)([0-9]{2}))|(([0-9]{3})([ ]?)([0-9]{3}))))\" style=\"padding-left: 48px;\" /><br />
            </label>
          </div>
